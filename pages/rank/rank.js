...
Page({
  ...
  data: {
    ...
    playpic: "../../images/cm2_discover_icn_mv@2x.png"
  },
  ...
  onLoad: function (options) {
    ...
    wx.request({
      url: 'https://v1.itooi.cn/netease/songList?id=141998290', //发送请求到服务器
      header: {
  ...
  openPlay: function (e) {
    ...
    wx.setStorage({
      key: 'songInfo',
      data: this.data.songlist.tracks[id],
    })
  ...
  change:function(){
    if (this.data.isPlayingMusic) {
      ...
      this.setData({
        playpic: "../../images/cm2_discover_icn_upbill-ip6@2x.png"
      })
    }
